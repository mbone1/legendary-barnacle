...
$(".citySearch").click(function() {
    // fiveDayForecastMaker();

    if (cityArr.includes(city)) {
        return;
    } else {
        $(".leftcol").innerHTML = "asdfasdfasdfasdfasdf";
        cityArr.push(city);
        $(".cities").append(
            "<div>" +
            "</div>" +
    ...
    $.ajax({
        ...
        //◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙◙ ⮙ PULLING LAT/LON FROM FIRST AJAX CALL
...
function imgMaker(walter) {
    $("#topCard").append("<img src=" + walter + ">");
}